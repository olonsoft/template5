...
// Constructor
// ─────────────────────────────────────────────
SensorHandler::SensorHandler(EventBus& bus, ManageHa& ha,
                             uint8_t pin, uint8_t dhtType)
...
void SensorHandler::begin() {
    ...
    olog.info(TAG, "Sensor handler started — interval %ds",
              DeviceDefaults::SENSOR_INTERVAL / 1000);
}
...
void SensorHandler::readAndPublish() {
    ...
    olog.info(TAG, "Temperature: %.1f°C  Humidity: %.1f%%",
